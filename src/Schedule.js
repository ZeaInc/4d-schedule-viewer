const { TreeItem, EventEmitter, loadBinfile, loadXMLfile, Registry } = zeaEngine
    ...
    return new Promise((resolve, reject) => {
      ...
      loadBinfile(
        ...
        (data) => {
          ...
          this.projectStartDate = moment(rows[0]['Planned Start'], 'MM/DD/YYYY').toDate()
          ...
          rows.forEach((row, index) => {
            ...
            if (task.end) {
              if (task.end > this.projectEndDate) this.projectEndDate = task.end
            }
